...
import { Home, Sun, Radio, Compass, Activity, BookOpen, Moon, Palette } from 'lucide-react';
...
export default function App() {
  ...
  const navItems = [
    { id: 'home', icon: Home, label: 'Home', color: 'text-slate-300', activeColor: 'text-white' },
    { id: 'aura', icon: Sun, label: 'Aura', color: 'text-purple-500/50', activeColor: 'text-purple-400' },
    { id: 'freq', icon: Radio, label: 'Freq', color: 'text-blue-500/50', activeColor: 'text-blue-400' },
    { id: 'soul', icon: Compass, label: 'Soul', color: 'text-yellow-500/50', activeColor: 'text-yellow-400' },
    { id: 'track', icon: Activity, label: 'Track', color: 'text-emerald-500/50', activeColor: 'text-emerald-400' },
    { id: 'codex', icon: BookOpen, label: 'Codex', color: 'text-slate-500/50', activeColor: 'text-slate-300' },
    { id: 'logos', icon: Palette, label: 'Logos', color: 'text-pink-500/50', activeColor: 'text-pink-400' },
  ];
  ...
  return (
    <div className="min-h-screen bg-cosmic-bg text-white font-sans selection:bg-purple-500/30 relative overflow-hidden">
      ...
      <main className="relative z-10 h-screen overflow-y-auto pb-24 custom-scrollbar">
        {/* Theme Toggle */}
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive ? "bg-white/5 scale-110" : "hover:bg-white/5"
                )}
              >
                <item.icon 
                  size={isActive ? 24 : 20} 
